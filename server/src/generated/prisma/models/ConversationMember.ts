...
export type ConversationMemberWhereInput = {
  ...
  joinAt?: Prisma.DateTimeFilter<"ConversationMember"> | Date | string
...
export type ConversationMemberScalarWhereWithAggregatesInput = {
  ...
  joinAt?: Prisma.DateTimeWithAggregatesFilter<"ConversationMember"> | Date | string
}
...
export type ConversationMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "conversationId" | "joinAt", ExtArgs["result"]["conversationMember"]>
...
export interface ConversationMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const conversationMemberWithUserIdOnly = await prisma.conversationMember.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ConversationMembers and only return the `userId`
   * const conversationMemberWithUserIdOnly = await prisma.conversationMember.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ConversationMembers and only return the `userId`
   * const conversationMemberWithUserIdOnly = await prisma.conversationMember.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ConversationMemberFieldRefs {
  ...
  readonly joinAt: Prisma.FieldRef<"ConversationMember", 'DateTime'>
}
