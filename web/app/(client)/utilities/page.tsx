    ...
    <TableRow className={`group transition-all ${isLocked ? "bg-emerald-50/30" : "hover:bg-slate-50/50"}`}>
      ...
      <TableCell>
        ...
        `}>
          <div className="flex flex-col min-w-12.5 pl-1 opacity-60">
            ...
            <span className="font-mono font-semibold text-slate-600">{eOld}</span>
          </div>
          ...
          <div className="flex-1 relative">
            <Input
              ...
              className="border-none bg-transparent shadow-none h-10 font-semibold focus-visible:ring-0 disabled:opacity-100"
              value={eNew}
      ...
      <TableCell>
        ...
        `}>
          <div className="flex flex-col min-w-12.5 pl-1 opacity-60">
            <span className="text-[9px] font-bold uppercase">Cũ</span>
            <span className="font-mono font-semibold text-slate-600">{wOld}</span>
          </div>
          <ArrowRight className={`w-3 h-3 ${isLocked ? 'text-emerald-300' : 'text-slate-300'}`} />
          <div className="flex-1 relative">
            <Input
